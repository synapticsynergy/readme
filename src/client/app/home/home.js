(function() {
  'use strict';
  angular.module('app.home', ['app.home.entries', 'app.home.insights', 'app.home.journal', 'app.home.about']).controller(
  ...
  function HomeController($scope, $mdSidenav, $window, $location, Home, Auth, $rootScope, $state, store) {
    ...
    $scope.userDateInit = function() {
      ...
      $scope.maxDate = new Date($scope.userDate.getFullYear(), $scope.userDate.getMonth(), $scope.userDate.getDate());
    }();
